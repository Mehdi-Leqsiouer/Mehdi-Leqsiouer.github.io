...
;(function (root, factory) {
  ...
  var Settings = {
    ...
    duration: 500,
    title: 'CAPTCHA',
    text: 'Glissez pour redresser l\'image',
    extra: null,
    extraColor: '#4E6EF2',
  ...
  RVerify.action = function (callback) {
    ...
    var modal =
      '<div class="rv-root" style="z-index: 15;"><div class="rv-mask"></div><div class="rv-wrap"><div class="rv-close">' +
      Settings.closeIcon +
  ...
  function RandomAngle(tolerance) {
    if (tolerance < 5 || tolerance > 45) {
      console.error('Please make sure the tolerance value is between 5Â°~45Â°.');
    } else {
      return (
